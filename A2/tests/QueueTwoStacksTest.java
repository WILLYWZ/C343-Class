...
public class QueueTwoStacksTest {
    QueueTwoStacks<Integer> list1 = new QueueTwoStacks<>();
    QueueTwoStacks<Integer> list2 = new QueueTwoStacks<>();
    QueueTwoStacks<String> list3 = new QueueTwoStacks<>();
    QueueTwoStacks<String> list4 = new QueueTwoStacks<>();
    @Before
